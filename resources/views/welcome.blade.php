...
@section('content')
<!-- Hero Section -->
<section class="bg-blue-600 text-white py-20 rounded-lg mb-8">
    <div class="container mx-auto px-4 text-center">
        <!-- Título y mensaje de bienvenida -->
        <h2 class="text-4xl font-bold mb-4">Bienvenido a OtorrinoNet</h2>
        <p class="text-xl mb-8">Especialista en Otorrinolaringología</p>
        <a href="{{ route('appointment.create') }}" class="bg-white text-blue-600 px-6 py-3 rounded-full font-bold hover:bg-gray-100 transition duration-300">Agendar Cita</a>
    </div>
</section>
...
<section class="bg-gray-100 py-16 rounded-lg">
    <div class="container mx-auto px-4">
